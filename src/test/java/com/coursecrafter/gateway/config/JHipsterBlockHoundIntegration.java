package com.coursecrafter.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.coursecrafter.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.coursecrafter.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
